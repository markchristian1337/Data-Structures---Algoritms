...
simpleLinkedList::~simpleLinkedList(){
    ...
    while (first != NULL) //while there are nodes in the list
    {
        ...
        first = first->link; //advance first to the link node
...
void simpleLinkedList::insertAt(int data, int location){
    Node* node = new Node();
    node->data = data;
    node->link = NULL;
...
void simpleLinkedList::remove(int deleteItem){
    ...
    {
        if (this->first->data == deleteItem) //Case 2
        {
            current = this->first;
...
void simpleLinkedList::insertSorted(int data){
    Node* node = new Node();
    node->data = data;
    node->link = NULL;
